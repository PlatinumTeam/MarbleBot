...
commandDictionary['LOCATION'] = require('./Commands/LocationCommand');
...
messageDictionary['INFO'] = require('./Messages/InfoMessage');
messageDictionary['NOTIFY'] = require('./Messages/NotifyMessage');
